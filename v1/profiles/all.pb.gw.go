...
var (
	...
	pattern_ProfileService_GetProfileCard_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "profile", "card"}, "", runtime.AssumeColonVerbOpt(true)))
)
