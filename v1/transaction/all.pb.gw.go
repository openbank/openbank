...
var (
	...
	pattern_TransactionService_ResendTFA_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "transactions", "resend"}, "", runtime.AssumeColonVerbOpt(true)))
)
