...
func local_request_BankService_GetBank_0(ctx context.Context, marshaler runtime.Marshaler, server BankServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.URL.Query(), filter_BankService_GetBank_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
var (
	pattern_BankService_GetBank_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "banks", "ID"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_BankService_GetBanks_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "banks"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_BankService_CreateBank_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "banks"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_BankService_UpdateBank_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "banks"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_BankService_DeleteBank_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "banks", "ID"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_BankService_CreateTranscationTypeAtBank_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "banks", "transaction-types"}, "", runtime.AssumeColonVerbOpt(true)))
)
