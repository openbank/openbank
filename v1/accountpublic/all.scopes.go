...
var AuthScopes = map[string][]string{
	"/accountpublic.AccountPublicService/GetBankPublicAccount":       {"https://auth.bnk.to/accountpublic.read"},
	"/accountpublic.AccountPublicService/GetPublicAccountAtAllBanks": {"https://auth.bnk.to/accountpublic.read"},
	"/accountpublic.AccountPublicService/GetPublicAccountByID":       {"https://auth.bnk.to/accountpublic.read"},
}
