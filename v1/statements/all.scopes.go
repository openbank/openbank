...
var AuthScopes = map[string][]string{
	"/statements.StatementService/GetStatement": []string{"https://auth.bnk.to/statement.read"},
	"/statements.StatementService/GetStatements": []string{"https://auth.bnk.to/statement.read"},
}
