...
var AuthScopes = map[string][][]string{
	"/consent.ConsentService/AnswerConsentChallenge": [][]string{
		{"https://auth.bnk.to/consent.write",},
	},
	"/consent.ConsentService/CreateConsentEmail": [][]string{
		{"https://auth.bnk.to/consent.write",},
	},
	"/consent.ConsentService/CreateConsentSMS": [][]string{
		{"https://auth.bnk.to/consent.write",},
	},
	"/consent.ConsentService/GetConsents": [][]string{
		{"https://auth.bnk.to/consent.read",},
	},
	"/consent.ConsentService/RevokeConsent": [][]string{
		{"https://auth.bnk.to/consent.write",},
	},
}
